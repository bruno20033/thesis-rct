...
Qualtrics.SurveyEngine.addOnReady(function () {
  ...
  function handleMessage(event) {
    ...
    if (data.type === 'rct_log_update' && data.payload) {
      ...
      try {
        // -----------------------------------------------------------
        // NSE COMPATIBILITY: setJSEmbeddedData() is the ONLY method
        // that persists in Qualtrics New Survey Engine (NSE).
        // It writes to __js_<fieldName> in the response data.
        // All corresponding fields MUST be declared with __js_
        // prefix in Survey Flow Embedded Data.
        //
        // Fields set by Survey Flow Randomizer (condition, arm,
        // cr_set) are NOT set here — they use non-prefixed names
        // and are handled server-side.
        // -----------------------------------------------------------
