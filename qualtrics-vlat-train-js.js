/* ====================================================================
 * QUALTRICS QUESTION JAVASCRIPT — VLAT *AIDED TRAINING* phase.
 *
 ...
 *   - the Post-Test full-VLAT fields (vlat_<id>_response, ...).
 ...
 *
 * postMessage protocol (embed-vlat.html -> this bridge):
 ...
 * vlat_scoring.js. This bridge therefore writes responses + timing,
 * never accuracy.
 *
 * --------------------------------------------------------------------
 ...
 *
 *   Core telemetry:
 *     vlat_train_InteractionLog, vlat_train_interaction_log,
 *     vlat_train_phase, vlat_train_model_used, vlat_train_session_id,
 *     vlat_train_prompt_count, vlat_train_response_count,
 *     vlat_train_current_question_index, vlat_train_question_count
 *
 *   VLAT productivity outcome (RQ2 — responses only):
 *     vlat_train_total, vlat_train_answered, vlat_train_attempted,
 *     vlat_train_responses (JSON array, authoritative for scoring),
 *     and per item id in {8,11,12,18,31,38,49,51,55}:
 *       vlat_train_<id>_answer, vlat_train_<id>_chart,
 *       vlat_train_<id>_format, vlat_train_<id>_slot,
 *       vlat_train_<id>_time
 *
 *   Judge metadata (Socratic arm; empty otherwise):
 *     vlat_train_judge_model, vlat_train_judge_mode,
 *     vlat_train_judge_call_count, vlat_train_judge_failure_count,
 *     vlat_train_judge_avg_fidelity, vlat_train_judge_min_fidelity,
 *     vlat_train_judge_below_threshold_count,
 *     vlat_train_judge_extraction_attempt_count,
 *     vlat_train_judge_total_latency_ms
 *
 *   Per-turn K = 1..20 (chat / search / judge):
 *     vlat_train_prompt_K, vlat_train_response_K,
 *     vlat_train_search_query_K, vlat_train_search_click_K,
 *     vlat_train_search_click_title_K, vlat_train_search_click_query_K,
 *     vlat_train_search_click_index_K, vlat_train_search_dwell_ms_K,
 *     vlat_train_judge_fidelity_K, vlat_train_judge_intent_K,
 *     vlat_train_judge_fidelity_reasoning_K,
 *     vlat_train_judge_intent_reasoning_K, vlat_train_judge_status_K,
 *     vlat_train_judge_latency_ms_K, vlat_train_judge_active_regen_K
 *
 *   Last-turn + transcripts + search aggregates:
 *     vlat_train_last_prompt, vlat_train_last_response,
 *     vlat_train_last_search_query, vlat_train_all_prompts,
 *     vlat_train_all_responses, vlat_train_all_search_queries,
 *     vlat_train_all_clicked_urls, vlat_train_total_clicks,
 *     vlat_train_total_dwell_ms, vlat_train_query_count,
 *     vlat_train_click_count
 *
...
Qualtrics.SurveyEngine.addOnReady(function () {
  ...
  var P = 'vlat_train_';             // phase field prefix
  var MAX_TURNS = 20;
  ...
  function handleMessage(event) {
    ...
    if (data.type === 'rct_log_update' && data.payload) {
      ...
      try {
        ...
        // =============================================================
        // VLAT responses (the productivity outcome — RQ2). Responses
        // only; correctness scored offline by vlat_scoring.js.
        ...
        if (data.vlat_items && Array.isArray(data.vlat_items)) {
          ...
          for (var vi = 0; vi < data.vlat_items.length; vi++) {
            ...
            var rid = (it.raw_id != null) ? it.raw_id : it.id;   // stable item id
        ...
        console.warn('[VLAT-train bridge] setEmbeddedData failed:', e);
      }
    }
   ...
   * (not by phase), so it works unchanged for the VLAT training phase.
   *
   ...
   * semantics); the rich vlat_train_InteractionLog preserves every turn.
   * =================================================================== */
  ...
  console.log('[VLAT-train bridge] listening for iframe postMessage events.');
});
